...
@FacesConverter("evaluacionDesempenoConvert")
public class EvaluacionDesempenoConvert implements Converter{
     @Override
        ...
        try {
            if (uic instanceof PickList) {
                ...
                for (Object o : dl.getSource()) {
                    String id = "" + ((PersonalEDBean) o).getCodigoPer();
                    if (string.equals(id)) {
                        ret = o;
                        break;
                    }
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        try {
            if (o != null) {
                return String.valueOf(((PersonalEDBean) o).getCodigoPer());
            } else {
                return null;
            }
        } catch (Exception e) {
