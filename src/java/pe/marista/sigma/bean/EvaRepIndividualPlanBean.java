 ...
 * @author MS001
 */
public class EvaRepIndividualPlanBean {
    ...
    public String getPromedio_tab() {
        return promedio_tab;
    }

    public void setPromedio_tab(String promedio_tab) {
        this.promedio_tab = promedio_tab;
    }

    public String getPonderacion_tab() {
        return ponderacion_tab;
    }

    public void setPonderacion_tab(String ponderacion_tab) {
